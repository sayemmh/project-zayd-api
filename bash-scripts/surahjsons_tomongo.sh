...
do
  ...
  mongoimport --host Cluster0-shard-0/cluster0-shard-00-00-hbqdc.mongodb.net:27017,cluster0-shard-00-01-hbqdc.mongodb.net:27017,cluster0-shard-00-02-hbqdc.mongodb.net:27017 --ssl --username $MONGO_USER --password $MONGO_PW --authenticationDatabase admin --db $MONGO_DB_NAME --collection $COLLECTIONS_NAME --type JSON --file $LOCAL_DIR/temp
